"""Normalised-clip loader adapter + fake (M08 Step 7).

Same shape as M06/M07's: ``video.normalized`` carries the clip reference, not its
frames, so the tracker needs the clip's geometry to run over. The real loader
